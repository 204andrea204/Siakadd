...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <link rel="icon" type="img/png" href="/login-template/Universitas Trilogi_files/10.jpg" sizes="16x16">
  ...
  <!-- Custom fonts for this template-->
        ...
        <style type="text/css">
            .login-page .form-box .univ-identity-box{
                background: linear-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2)),url('/not_found/sekolah.jpg') bottom;
                background-size:cover;
            }
            html, body{
                background-image: url('https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTOiyRT2iE0yCFCeuK-4PfDX3QX2w7sqYmvs_jq34A9rArFEsos');
                background-size: cover;
            }
            .password{
                position: relative;
                    ...
                    <div class="col-lg-7 col-md-6 col-sm-6 col-xs-12 univ-identity-box">
                        <div class="univ-text-container">
                            <div class="univ-text">
                                ...
                                <h2 class="no-margin text-light">S I A K A D</h2>
                                <h3 class="no-margin"><b>Cyber SOft</b></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5 col-md-6 col-sm-6 col-xs-12 form-login" align="center">
                        <img src="/not_found/10.jpg" class="logo"><br>
                        <h2 align="center" class="text-grey text-light">Silakan Login</h2><br>
                        <form method="POST" action="/halaman/proses-login">
                            @csrf

                            <div class="form-group">
                                <i class="fa fa-user icon-input"></i> 
                                <input type="text" name="username" id="userid" class="form-control input-line" placeholder="Masukan Username Atau Email">
                            </div>
                            <div class="form-group">
                                <div class="password">
