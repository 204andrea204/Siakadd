          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <a href="/jurusan/delete/{{$j->id}}" class="btn btn-outline-danger">
...
<div class="modal fade" id="modaladd" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="/jurusan/add" method="POST" enctype="multipart/form-data">
        	@csrf
...
@foreach($jurusan as $j)
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="/jurusan/update" method="POST" enctype="multipart/form-data">
        	@csrf
