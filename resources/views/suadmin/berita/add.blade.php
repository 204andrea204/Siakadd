	...
	<div class="container-fluid">
		<div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  <form method="POST" action="/berita/add" enctype="multipart/form-data">
                  	@csrf
                    <div class="row">
                      <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        <div class="form-group bmd-form-group">
                          <input placeholder="Pembuat" name="pembuat" type="text" class="form-control">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group bmd-form-group">
                          <input placeholder="Tanggal Di Upload" name="tanggal" type="date" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group bmd-form-group">
                          <input placeholder="Link Video" name="video" type="text" class="form-control">
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="col-md-12">
                        <div class="form-group bmd-form-group">
                          ...
                          <textarea id="ckeditor1" class="contact-message" cols="30" rows="10" name="isi"></textarea>
                        </div>
                      </div>
                    </div>
